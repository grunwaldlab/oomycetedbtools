...
#'   spreadsheet on the server relative to the root of the website directory.
#' @param release_spreadsheet_name The name of the release spreadsheet on Google Drive with no
#'   extension.
#' @param local_release_dir The path to the directory containing the archived FASTA files for all
#'   releases on the server relative to the root of the website.
#' @param release_name_prefix Text added to the beginning of the archived FASTA files on the server.
#' @param blast_database_dir The path to the directory containing the archived blast databases for all
#'   releases on the server relative to the root of the website.
#' @param blast_path The path to the folder with blast executable
#'
#' @export
